-- ============================================================
-- Migration 24: Update submit_pengajuan to include privacy_event, nama_ustadz, judul_kajian, url_flyer, is_multi_day_daily
-- ============================================================
...
BEGIN
  ...
  INSERT INTO public.pengajuan_peminjaman (
    ...
    pengajuan_data->>'url_flyer',
    COALESCE((pengajuan_data->>'privacy_event')::privacy_event, 'detail_publik'::privacy_event),
