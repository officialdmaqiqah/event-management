...
export default function EventDetailPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Main Content Pane */}
      <div className="max-w-5xl mx-auto px-0 pb-10">
                        ...
                        <Table>
                          <TableHeader className="bg-slate-50/60">
                            <TableRow>
                              ...
                              <TableHead className="font-semibold text-slate-600 text-xs py-3.5">L/P</TableHead>
                              ...
                              <TableHead className="font-semibold text-slate-600 text-xs py-3.5">Kode Tiket</TableHead>
                              <TableHead className="font-semibold text-slate-600 text-xs py-3.5">Status</TableHead>
                              <TableHead className="font-semibold text-slate-600 text-xs py-3.5 text-right w-[200px]"></TableHead>
                            </TableRow>
                          </TableHeader>
                          <TableBody>
                            {participants.map((p) => (
                              <TableRow key={p.id} className="hover:bg-slate-50/50">
                                ...
                                <TableCell className="text-slate-650 text-xs py-3">{p.gender === 'Pria' ? 'L' : p.gender === 'Wanita' ? 'P' : '-'}</TableCell>
                                <TableCell className="text-slate-650 text-xs py-3">{p.organization || '-'}</TableCell>
                                <TableCell className="text-slate-500 font-mono text-xs py-3">{p.whatsapp}</TableCell>
                                <TableCell><code className="bg-slate-100 px-1 py-0.5 rounded text-xs">{p.ticket_code}</code></TableCell>
                    ...
                    <Table>
                      <TableHeader className="bg-slate-50/60">
                        <TableRow>
                          ...
                          <TableHead className="font-semibold text-slate-600 text-xs py-3.5 text-right pr-6 w-[120px]"></TableHead>
                        </TableRow>
                      </TableHeader>
                      <TableBody>
