...
export default function EditEventPage({ params }: { params: { id: string } }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (bannerFile) {
      ...
      updatePayload.banner_url = supabase.storage.from('event_assets').getPublicUrl(fileName).data.publicUrl
    }
    ...
    if (logoFile) {
      ...
      updatePayload.logo_url = supabase.storage.from('event_assets').getPublicUrl(fileName).data.publicUrl
    }
