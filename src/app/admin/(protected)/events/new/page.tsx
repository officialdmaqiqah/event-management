          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-gray-100 mt-4">
                <div className="space-y-2">
                  <Label htmlFor="banner" className="text-gray-700">Upload Banner / Flyer Event</Label>
                  <Input 
                    id="banner" 
                    type="file" 
                    accept="image/*" 
                ...
                <div className="space-y-2">
                  <Label htmlFor="logo" className="text-gray-700">Upload Logo Penyelenggara</Label>
                  <Input 
                    id="logo" 
                    type="file" 
                    accept="image/*" 
                    ...
                    className="bg-gray-50 cursor-pointer" 
                  />
                  <p className="text-xs text-gray-500">Format: JPG/PNG transparan (disarankan).</p>
                </div>
              </div>
