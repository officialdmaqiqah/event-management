  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold tracking-tight">Manajemen Event Publik</h1>
        <Link href="/admin/events/new">
          <Button className="bg-indigo-600 hover:bg-indigo-700">+ Buat Event Publik Baru</Button>
        </Link>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Event Publik Anda</CardTitle>
          <CardDescription>Kelola semua pendaftaran event publik yang telah Anda buat</CardDescription>
        </CardHeader>
        <CardContent>
