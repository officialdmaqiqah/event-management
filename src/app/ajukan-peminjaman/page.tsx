  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        tanggal_mulai: new Date(`${event.tanggal_mulai}T${event.jam_mulai}:00+07:00`).toISOString(),
        tanggal_selesai: new Date(`${event.tanggal_selesai}T${event.jam_selesai}:00+07:00`).toISOString(),
