...
export default function FloatingWhatsApp() {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 bg-emerald-500 text-white rounded-full shadow-[0_4px_14px_0_rgba(16,185,129,0.39)] group-hover:bg-emerald-600 group-hover:scale-105 group-hover:shadow-[0_6px_20px_rgba(16,185,129,0.25)] transition-all duration-300">
        <svg
          viewBox="0 0 24 24"
          fill="currentColor"
